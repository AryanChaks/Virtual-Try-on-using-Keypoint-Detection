...
class VITONDataset(data.Dataset):
    def __init__(self, opt):
        ...
        # print(f"Dataset directory is {opt.dataset_dir}")
        # print(f"Dataset mode is {opt.dataset_mode}")
        # print(f"Prepared data path is {self.data_path}")
    ...
    def __getitem__(self, index):
        ...
        for key in self.c_names:
            ...
            c[key] = c[key].resize((self.load_width, self.load_height), Image.BILINEAR)
            cm[key] = Image.open(osp.join(self.data_path, 'cloth-mask', c_name[key]))
            cm[key] = cm[key].resize((self.load_width, self.load_height), Image.NEAREST)
...
class VITONDataLoader:
    def __init__(self, opt, dataset):
        ...
        # print(f'Data Loader is {self.data_loader}')
